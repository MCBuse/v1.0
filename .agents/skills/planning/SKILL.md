...
**Never start coding without a plan.** You are the architect. Codex is the builder. A builder without a blueprint makes a mess. A builder with a clear blueprint moves fast and gets it right.
...
1. Ask Codex to create a \`PLAN.md\` in your project root (or a \`docs/plans/\` folder)
...
3. Review the plan, make changes, then tell Codex to execute it step by step
...
**Tell Codex not to code.** Explicitly. If you don't say "don't write code yet," Codex will start building immediately. The phrase "don't write any code yet, just give me the plan" is the most important sentence in your workflow.
