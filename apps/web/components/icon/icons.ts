/**
 * Web icon registry — maps semantic icon names to SVG React components.
 * SVGs are transformed by @svgr/webpack (configured in next.config.js).
 *
 * Adding a new icon:
 *   1. Drop the SVG into packages/icons/assets/<category>/
 *   2. Add an entry below
 *   3. Add the name to @repo/icons/src/index.ts
 */
...
export const icons: Record<IconName, ComponentType<any>> = {
  home: HomeIcon, 'home-plain': HomePlainIcon, search: SearchIcon,
  menu: MenuIcon, 'menu-grid': MenuGridIcon, setting: SettingIcon,
  notification: NotificationIcon, 'notification-dot': NotificationDotIcon,
  time: TimeIcon, bookmark: BookmarkIcon,
  'arrow-left': ArrowLeftIcon, 'arrow-right': ArrowRightIcon,
  'arrow-up': ArrowUpIcon, 'arrow-down': ArrowDownIcon,
  'arrow-send': ArrowSendIcon, 'circle-arrow-right': CircleArrowRightIcon,
  'circle-arrow-up': CircleArrowUpIcon, 'circle-arrow-down': CircleArrowDownIcon,
  'small-arrow-right': SmallArrowRightIcon, refresh: RefreshIcon,
  transaction: TransactionIcon,
  'credit-card': CreditCardIcon, 'credit-card-check': CreditCardCheckIcon,
  'credit-card-send': CreditCardSendIcon, 'credit-card-get': CreditCardGetIcon,
  receipt: ReceiptIcon, 'receipt-simple': ReceiptSimpleIcon,
  wallet: WalletIcon, dollar: DollarIcon, naira: NairaIcon,
  user: UserIcon, 'user-circle': UserCircleIcon, 'user-add': UserAddIcon,
  'user-check': UserCheckIcon, 'user-search': UserSearchIcon, group: GroupIcon,
  plus: PlusIcon, 'plus-circle': PlusCircleIcon, minus: MinusIcon,
  cross: CrossIcon, 'cross-circle': CrossCircleIcon,
  check: CheckIcon, 'check-circle': CheckCircleIcon,
  edit: EditIcon, delete: DeleteIcon, share: ShareIcon,
  download: DownloadIcon, filter: FilterIcon, flag: FlagIcon,
  message: MessageIcon, envelope: EnvelopeIcon, phone: PhoneIcon,
  support: SupportIcon,
  shield: ShieldIcon, lock: LockIcon, 'lock-open': LockOpenIcon,
  fingerprint: FingerprintIcon, 'face-id': FaceIdIcon, key: KeyIcon,
  eye: EyeIcon, 'eye-off': EyeOffIcon, id: IdIcon,
  scan: ScanIcon, nfc: NfcIcon, network: NetworkIcon, link: LinkIcon,
  info: InfoIcon, warning: WarningIcon, question: QuestionIcon,
  forbid: ForbidIcon, target: TargetIcon,
  chart: ChartIcon, 'chart-bar': ChartBarIcon, report: ReportIcon,
  'log-out': LogOutIcon,
  calendar: CalendarIcon, location: LocationIcon, cloud: CloudIcon,
  device: DeviceIcon, bulb: BulbIcon, sun: SunIcon, moon: MoonIcon,
};
